...
python DataExtractor.py splitDataIdx --base-dir ${basedir} --out-dir ${outdir} ;

# 'createChunk', help='Build data chunk from saved index'
# '--chunkIdx', help='path to indeces for chunk windows relative to base-dir'
chunkIdx='/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/002_data_indices_10000_0_0.8.pkl'
...
out='/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/002_split_data_10000_0_0.8_add_tracks.h5'
