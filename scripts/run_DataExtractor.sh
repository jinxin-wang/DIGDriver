...
outdir="/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/window${window}"
...
basedir="/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/window${window}/"
...
chunkIdx="/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/window${window}/002_data_indices_${window}_0_0.8.pkl"
...
# !!!! Important setting, bins has to be 100 to meet correct input size
bins='100'
...
data="/mnt/beegfs/scratch/j_wang/03_Results/Dig/h5/window${window}/002_split_data_${window}_0_0.8.h5"
